...
| 2         | 10:30 - 11:30  | Open Source Health & the future of OS (Andres & Michael) | Analog Computing (Thaddeus) | 2029 CS graduates (Cay)                                                                     | Better AI Prompts (Cliff) | How to unslop development (Finkelshteyn) | [MCPs and Java standardisation (Drazen)](/day-1/session2/mcps-and-java.md) |
| 3         | 11:45 - 12:45  | Do you need ID in the era of AI Agents? (Anton) | [AI is going to... (Jens)](https://blog.schauderhaft.de/AI-Will-Fuck-Us-Over/#/) | [How to get others care about modern Java](./day-1/session3/care-about-modern-java/README.md) (Sven W.) | SSF Framework (Thomas) | Java can do Data Science too ()          | How AI will change encyrption in 5 years (Commer) |

## Day 2 (28.07.2026)

| Session # | Time/Room      | Main Room    | MX        | MS      | Library   | In         | Out |
|-----------|----------------|--------------|-----------|-------- |-----------|------------|-----|
| 4         | 09:15 - 10:15  |       -      | [AI Isolation Practices (Oleg)](./day-2/session4/ai-isolation-practices)   | [A Simple Compiler (C2 style) (Cliff)](https://github.com/SeaOfNodes) | Hobbies not AI (Andres) | - | AI in SDLC Non-Code (Gregorz) |
...
| Session # | Time/Room      | Main Room    | MX        | MS      | Library   | In         | Out |
|-----------|----------------|--------------|-----------|-------- |-----------|------------|-----|
| 7         | 09:15 - 10:15  | [Spec Driven Development (Victor, Pasha & Ina)](./day-3/session7/spec-driven-development/README.md) | Legal impacts of AI () | Pushing a PR to OpenJDK (Heinz) | History of Crete (Marko) | Building Personal Assistants with AI (Oleg) | Value of developers in terms of organisations value (Anita) |
...
| 12        | 16:45 - 17:45  | Code Reading; JFlatterner (Lefteris) | Hardwood (lib for parquet) (Gunmar) | Babylon (Remi + Cliff) | Making Space to Speak (Simons) | [From Compressed Oops to Compact Headers: Inside the JVM (Sven W.)](./day-4/session12/compact-object-headers/README.md) | Surviving AI Hype cycle without burnout (Ljuibisa) |
